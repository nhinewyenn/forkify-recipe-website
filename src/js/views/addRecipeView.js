...
class AddRecipeView extends View {
  ...
  _generateMarkup() {
    ...
    <label>Title</label>
    <input value="Input recipe name" required name="title" type="text" />
    <label>URL</label>
    <input value="Insert recipe URL" required name="sourceUrl" type="text" />
    <label>Image URL</label>
    <input value="Insert image URL" required name="image" type="text" />
    <label>Publisher</label>
    <input value="Input publisher name" required name="publisher" type="text" />
